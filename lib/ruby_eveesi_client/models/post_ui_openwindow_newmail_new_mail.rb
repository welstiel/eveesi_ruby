...
module RubyEveesiClient
  ...
  class PostUiOpenwindowNewmailNewMail
    ...
    attr_accessor :to_corp_or_alliance_id

    # Corporations, alliances and mailing lists are all types of mailing groups. You may only send to one mailing group, at a time, so you may fill out either this field or the to_corp_or_alliance_ids field
    attr_accessor :to_mailing_list_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RubyEveesiClient::PostUiOpenwindowNewmailNewMail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RubyEveesiClient::PostUiOpenwindowNewmailNewMail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'to_corp_or_alliance_id')
        self.to_corp_or_alliance_id = attributes[:'to_corp_or_alliance_id']
      end

      if attributes.key?(:'to_mailing_list_id')
        self.to_mailing_list_id = attributes[:'to_mailing_list_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subject == o.subject &&
          to_corp_or_alliance_id == o.to_corp_or_alliance_id &&
          to_mailing_list_id == o.to_mailing_list_id
    end
    ...
    def hash
      [body, recipients, subject, to_corp_or_alliance_id, to_mailing_list_id].hash
    end
