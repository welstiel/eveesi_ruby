  ...
  class GetUniverseTypesTypeIdOk
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RubyEveesiClient::GetUniverseTypesTypeIdOk` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RubyEveesiClient::GetUniverseTypesTypeIdOk`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@dogma_attributes.nil? && @dogma_attributes.length > 1000
        invalid_properties.push('invalid value for "dogma_attributes", number of items must be less than or equal to 1000.')
      end

      if !@dogma_effects.nil? && @dogma_effects.length > 1000
        invalid_properties.push('invalid value for "dogma_effects", number of items must be less than or equal to 1000.')
      end
    ...
    def valid?
      ...
      return false if !@dogma_attributes.nil? && @dogma_attributes.length > 1000
      return false if !@dogma_effects.nil? && @dogma_effects.length > 1000
    ...
    def dogma_attributes=(dogma_attributes)
      if !dogma_attributes.nil? && dogma_attributes.length > 1000
        fail ArgumentError, 'invalid value for "dogma_attributes", number of items must be less than or equal to 1000.'
      end
    ...
    def dogma_effects=(dogma_effects)
      if !dogma_effects.nil? && dogma_effects.length > 1000
        fail ArgumentError, 'invalid value for "dogma_effects", number of items must be less than or equal to 1000.'
      end
