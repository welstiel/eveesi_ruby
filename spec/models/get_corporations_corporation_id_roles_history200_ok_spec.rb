...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdRolesHistory200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdRolesHistory200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdRolesHistory200Ok.new }
  ...
  describe 'test an instance of GetCorporationsCorporationIdRolesHistory200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdRolesHistory200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdRolesHistory200Ok)
    end
  end
