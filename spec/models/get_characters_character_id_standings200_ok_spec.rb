...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdStandings200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdStandings200Ok do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdStandings200Ok.new }
  ...
  describe 'test an instance of GetCharactersCharacterIdStandings200Ok' do
    it 'should create an instance of GetCharactersCharacterIdStandings200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdStandings200Ok)
    end
  end
