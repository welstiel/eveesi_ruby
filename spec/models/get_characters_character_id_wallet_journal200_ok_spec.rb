...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdWalletJournal200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdWalletJournal200Ok do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdWalletJournal200Ok.new }
  ...
  describe 'test an instance of GetCharactersCharacterIdWalletJournal200Ok' do
    it 'should create an instance of GetCharactersCharacterIdWalletJournal200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdWalletJournal200Ok)
    end
  end
