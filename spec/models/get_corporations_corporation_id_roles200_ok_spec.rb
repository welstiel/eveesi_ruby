...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdRoles200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdRoles200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdRoles200Ok.new }

  describe 'test an instance of GetCorporationsCorporationIdRoles200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdRoles200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdRoles200Ok)
    end
  end
