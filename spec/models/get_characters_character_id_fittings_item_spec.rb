...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdFittingsItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdFittingsItem do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdFittingsItem.new }

  describe 'test an instance of GetCharactersCharacterIdFittingsItem' do
    it 'should create an instance of GetCharactersCharacterIdFittingsItem' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdFittingsItem)
    end
  end
