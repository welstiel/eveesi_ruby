...
# Unit tests for RubyEveesiClient::PostCharactersAffiliation200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::PostCharactersAffiliation200Ok do
  let(:instance) { RubyEveesiClient::PostCharactersAffiliation200Ok.new }
  ...
  describe 'test an instance of PostCharactersAffiliation200Ok' do
    it 'should create an instance of PostCharactersAffiliation200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::PostCharactersAffiliation200Ok)
    end
  end
