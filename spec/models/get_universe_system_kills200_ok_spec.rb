...
# Unit tests for RubyEveesiClient::GetUniverseSystemKills200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetUniverseSystemKills200Ok do
  let(:instance) { RubyEveesiClient::GetUniverseSystemKills200Ok.new }
  ...
  describe 'test an instance of GetUniverseSystemKills200Ok' do
    it 'should create an instance of GetUniverseSystemKills200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetUniverseSystemKills200Ok)
    end
  end
