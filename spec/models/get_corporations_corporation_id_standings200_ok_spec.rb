...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdStandings200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdStandings200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdStandings200Ok.new }
  ...
  describe 'test an instance of GetCorporationsCorporationIdStandings200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdStandings200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdStandings200Ok)
    end
  end
