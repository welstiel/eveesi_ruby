...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdOrders200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdOrders200Ok do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdOrders200Ok.new }

  describe 'test an instance of GetCharactersCharacterIdOrders200Ok' do
    it 'should create an instance of GetCharactersCharacterIdOrders200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdOrders200Ok)
    end
  end
