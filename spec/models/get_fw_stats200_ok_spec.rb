...
# Unit tests for RubyEveesiClient::GetFwStats200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetFwStats200Ok do
  let(:instance) { RubyEveesiClient::GetFwStats200Ok.new }

  describe 'test an instance of GetFwStats200Ok' do
    it 'should create an instance of GetFwStats200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetFwStats200Ok)
    end
  end
