...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdAssets200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdAssets200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdAssets200Ok.new }
  ...
  describe 'test an instance of GetCorporationsCorporationIdAssets200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdAssets200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdAssets200Ok)
    end
  end
