...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdWalletsDivisionJournal200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdWalletsDivisionJournal200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdWalletsDivisionJournal200Ok.new }
  ...
  describe 'test an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdWalletsDivisionJournal200Ok)
    end
  end
