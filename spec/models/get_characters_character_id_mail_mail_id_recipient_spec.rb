...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdMailMailIdRecipient
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdMailMailIdRecipient do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdMailMailIdRecipient.new }
  ...
  describe 'test an instance of GetCharactersCharacterIdMailMailIdRecipient' do
    it 'should create an instance of GetCharactersCharacterIdMailMailIdRecipient' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdMailMailIdRecipient)
    end
  end
