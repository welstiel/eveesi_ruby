...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdOrdersHistory200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdOrdersHistory200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdOrdersHistory200Ok.new }
  ...
  describe 'test an instance of GetCorporationsCorporationIdOrdersHistory200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdOrdersHistory200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdOrdersHistory200Ok)
    end
  end
