...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdBlueprints200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdBlueprints200Ok do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdBlueprints200Ok.new }

  describe 'test an instance of GetCharactersCharacterIdBlueprints200Ok' do
    it 'should create an instance of GetCharactersCharacterIdBlueprints200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdBlueprints200Ok)
    end
  end
