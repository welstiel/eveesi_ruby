...
# Unit tests for RubyEveesiClient::GetCharactersCharacterIdCalendarEventIdAttendees200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCharactersCharacterIdCalendarEventIdAttendees200Ok do
  let(:instance) { RubyEveesiClient::GetCharactersCharacterIdCalendarEventIdAttendees200Ok.new }
  ...
  describe 'test an instance of GetCharactersCharacterIdCalendarEventIdAttendees200Ok' do
    it 'should create an instance of GetCharactersCharacterIdCalendarEventIdAttendees200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCharactersCharacterIdCalendarEventIdAttendees200Ok)
    end
  end
