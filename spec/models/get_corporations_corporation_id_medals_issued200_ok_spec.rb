...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdMedalsIssued200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdMedalsIssued200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdMedalsIssued200Ok.new }
  ...
  describe 'test an instance of GetCorporationsCorporationIdMedalsIssued200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdMedalsIssued200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdMedalsIssued200Ok)
    end
  end
