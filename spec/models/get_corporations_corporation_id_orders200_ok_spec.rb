...
# Unit tests for RubyEveesiClient::GetCorporationsCorporationIdOrders200Ok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubyEveesiClient::GetCorporationsCorporationIdOrders200Ok do
  let(:instance) { RubyEveesiClient::GetCorporationsCorporationIdOrders200Ok.new }

  describe 'test an instance of GetCorporationsCorporationIdOrders200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdOrders200Ok' do
      expect(instance).to be_instance_of(RubyEveesiClient::GetCorporationsCorporationIdOrders200Ok)
    end
  end
